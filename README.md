...
For example for 2x SolarFlow 2400AC+ you can set it to max 4800 Watts. For 3x SolarFlow 2400AC+ to max 7200 Watts.
...
Requirement: This solution requires that you have already installed the Proxy sensors yaml code as instructed under [Monitoring](https://github.com/gast777/Zendure-zenSDK-proxy/blob/main/README.md#instructions-1).<br/>
Limitation: This supports switching the sockets On or Off. The ECO setting cannot be set.
