/**
 * Merge N Zendure /properties/report payloads for Gielz HA (zenSDK).
 * N in 1..3. Mirrors gast777 behaviour for N=2; extends aggregates for N=3.
 * @param {object[]} origs - parsed JSON from each device (same order as IPs)
 * @param {object} ctx - { flow, msg } flow = Node-RED flow context .get/.set
 */
